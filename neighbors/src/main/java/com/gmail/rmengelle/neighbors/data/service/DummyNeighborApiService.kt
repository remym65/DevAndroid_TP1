package com.gmail.rmengelle.neighbors.data.service
...
class DummyNeighborApiService : NeighborApiService {
    ...
    private val DUMMY_NeighborS: MutableList<Neighbor> = mutableListOf(
        Neighbor(
            1, "Caroline",
            "https://cdn.pixabay.com/photo/2017/06/01/13/16/peru-2363502_960_720.jpg",
        ...
        Neighbor(
            2,
            "Jack",
            "https://www.ecoheros.ca/public/content/wildwire/RedFoxFeaturedImage.jpg",
            "Saint-Pierre-du-Mont ; 5km",
            "+33 6 00 55 90 14",
            (
        ...
        Neighbor(
            5,
            "Elodie",
            "https://poissondijon.fr/127-large_default/daurade-royale-la-piece-de-500gr.jpg",
